...
<ol>
  <li>download file bahan tryout uas dan extract all</li>
  ...
  <li>memperbaiki kode validasi dan kode update where</li>
  <li>memperbaiki tampilan input nim dalam form edit biodata</li>
</ol>